...
//findFirstEVEN 함수는 매개변수로 numbers 배열을 받습니다.
//numbers.find 메서드는 콜백 함수를 통해 배열의 각 요소를 검사합니다.
function findFirstEvenNumber(numbers) {
  // 함수 내부를 채워주세요!
  // find 메서드는 첫 번째로 조건을 만족하는 요소 (첫번째 짝수인 8)를 반환합니다.
  return numbers.find(number => number % 2 === 0);
  // 여기서 number => number % 2 === 0 는 각 요소가 짝수인지 확인합니다. 
